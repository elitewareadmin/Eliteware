      ...
      <div className="container relative z-10 px-4 md:px-8 mx-auto">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="hero-subtitle text-lg md:text-xl text-gray-300 mb-10 max-w-2xl mx-auto">
            Consultoría tecnológica especializada en inteligencia artificial, metaverso y 
            software disruptivo para empresas que buscan liderar la transformación digital.
          </p>
